# Sovelluksen vähimmäisvaatimukset:
- Toimivat kortit laajennusmahdollisuuksineen “lisätietoa” painikkeesta -> modal auki ja yksityiskohtaisemmat reittitiedot näkyviin.
- Toimiva korttien filtteröinti tagien sekä pituus (km) sliderin perusteella.
- Light/dark mode?
